...
public class Name {
  ...
  private static final String NULL_NAME_ERROR_MESSAGE = "Branch name cannot be null.";
  private static final String MAX_LENGTH_ERROR_MESSAGE = "Branch name cannot be greater than 100.";
